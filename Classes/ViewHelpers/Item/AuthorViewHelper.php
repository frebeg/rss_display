...
/**
 * A View Helper which returns the "author" of a SimplePie item.
 */
class AuthorViewHelper extends AbstractViewHelper
{

    /**
     * Retrieve the SimplePie item from the context and return its "author".
     *
     * @return string
